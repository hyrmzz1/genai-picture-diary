...
const DeleteAccount = ({
  ...
  return (
    <div className="flex flex-col justify-start items-center gap-5 px-6 pt-7 pb-8 rounded-[20px] bg-white border border-[#efefef] z-10">
      ...
      <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-10">
        ...
        <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-2">
          ...
          <div
            onClick={onClose}
            className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 h-[52px] relative gap-2.5 px-8 py-3.5 rounded-[10px] bg-[#f5f5f5] cursor-pointer"
          >
